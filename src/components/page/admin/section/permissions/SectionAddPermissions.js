...
class SectionAddPermissions extends Component {
    ...
    submitData = (e) => {
        ...
        if (name.length >= 3  && label.length >= 5){

            Axios.post(`${API_ADMIN}/permission`,
                {
                ...
                if (response.data.status === "success") {
                    swal("عملیات موفق", "سطح دسترسی به درستی ثبت شد.", "success")
...
export default SectionAddPermissions;
